...
namespace TutorTrac2.WebUI.Controllers
{
    ...
    {
        IRepository<TutorAppointment> context;

        public TutorAppointmentController(IRepository<TutorAppointment> tutorAppointmentContext)
        {
            context = tutorAppointmentContext;
        }
